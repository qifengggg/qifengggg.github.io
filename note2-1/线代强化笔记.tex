...
\ctexset{
	...
	section={
		...
		%字号为小三，字体为黑体，左对齐
		%+号表示在原有格式下附加格式命令
		format+ = \zihao{2} \heiti \raggedright\centering,
		%name用于设置章节编号前后的词语
		%前、后词语用英文状态下,分开
		%如果没有前或后词语可以不填
		name = {,.\,},
		...
		%number = \Roman{sectionCnt},
		number = \chinese{sectionCnt},
...
\newcommand{\whichis}{\mathop=\limits^\triangle}
\newcommand{\R}{\mathbb R}
\newcommand{\qline}{\underline{~~~~~~~~~~}}

\newcommand{\Section}{\stepcounter{sectionCnt}\section}

\title{\includegraphics[scale=0.6]{1.jpg}\\ \textsf{线代强化笔记}}
